...
try: app_id = int(os.environ.get("app_id", "28870226"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "a5b1ff3f75941649bf5bc159782f0f00")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "7899900845:AAHEJZdghS15fvXPjWZf5t9chu65LpvtLm0")
except Exception as bot_token: print(f"⚠️ Bot Token Invalid {bot_token}")
try: custom_caption = os.environ.get("custom_caption", "`{file_name} Join @AllBotUpdatemy`")
...
about_message = """
<b>• Name : <a href=https://t.me/freemoviesLink02>CT AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/freemoviesLink02>[CT UPDATES]</a></b>
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="https://t.me/freemoviesLink02"),
   pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
   ],[
   pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/{bot.AutoCTCaptionBot}?startchannel=true")
   ]]
